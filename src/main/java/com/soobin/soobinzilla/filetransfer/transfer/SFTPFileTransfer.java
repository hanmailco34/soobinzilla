...
import com.soobin.soobinzilla.filetransfer.connector.SFTPConnector;
import com.soobin.soobinzilla.filetransfer.core.AbstractFileTransferProtocol;
import com.soobin.soobinzilla.filetransfer.handler.SFTPFileTransferHandler;
import com.soobin.soobinzilla.filetransfer.reader.SFTPDirectoryReader;
import com.soobin.soobinzilla.filetransfer.vo.FileInfoVO;
import com.soobin.soobinzilla.model.Connection;

public class SFTPFileTransfer extends AbstractFileTransferProtocol<ChannelSftp> {
	
	private SFTPConnector connector;
	private SFTPFileTransferHandler handler = new SFTPFileTransferHandler();
	private SFTPDirectoryReader reader;
	...
	public void loadIndex(String path, Boolean isReadStatus) throws FileTransferException {
		...
		this.reader = new SFTPDirectoryReader(this.connector.getClient(), super.getFileIndexManager());
	}

	@Override
	public void readDirectory(String directory, Boolean isRecursive) throws FileTransferException {
		this.reader.readDirectory(directory, true);
	}
