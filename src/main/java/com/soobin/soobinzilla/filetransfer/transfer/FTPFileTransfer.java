...
import com.soobin.soobinzilla.filetransfer.connector.FTPConnector;
import com.soobin.soobinzilla.filetransfer.core.AbstractFileTransferProtocol;
import com.soobin.soobinzilla.filetransfer.handler.FTPFileTransferHandler;
import com.soobin.soobinzilla.filetransfer.reader.FTPDirectoryReader;
import com.soobin.soobinzilla.filetransfer.vo.FileInfoVO;
import com.soobin.soobinzilla.model.Connection;

public class FTPFileTransfer extends AbstractFileTransferProtocol<FTPClient> {
	
	private FTPConnector connector;
	private FTPFileTransferHandler handler = new FTPFileTransferHandler();
	private FTPDirectoryReader reader;
	
	public FTPFileTransfer() {
		this.connector = new FTPConnector();
	}
	...
	public void loadIndex(String path, Boolean isReadStatus) throws FileTransferException {
		...
		this.reader = new FTPDirectoryReader(this.connector.getClient(), super.getFileIndexManager());
	}
